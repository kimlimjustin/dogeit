            ...
            <div className="box auth-box">
                ...
                <form onSubmit={LoginForm} method="POST">
                    ...
                    <div className="form-group">
                        ...
                        <a className="github-oauth-button btn form-control" href={`https://github.com/login/oauth/authorize?client_id=${process.env.REACT_APP_GITHUB_CLIENT_ID}`} title="Login with GitHub">Login with GitHub</a>
                    </div>
                </form>
            </div>
        </div>
