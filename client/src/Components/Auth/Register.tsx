...
const Register = (props: Prop) => {
    ...
    return(
        ...
        <Link className="github-login-corner" to={`https://github.com/login/oauth/authorize?client_id=${process.env.REACT_APP_GITHUB_CLIENT_ID}`} title="Login with GitHub">
            ...
            <div className="box auth-box">
                ...
                <form onSubmit={RegisterUser} method="POST">
                    ...
                    <div className="form-group">
                        <div className="row">
                            <div className="col-6">
                                <p className="form-label">Already have account? <Link className="link" to="/login">Login</Link></p>
                            </div>
                            <div className="col-6">
